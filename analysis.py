...
def analyze_taxi_co2():
    ...
    try:
        ...
        for color in ["yellow","green"]:
            ...
            car_str = f"""Most carbon-intensive trip for {color} taxis: {con.execute(f"""SELECT MAX(trip_co2_kgs) 
            ...
            for frame in frames:
                ...
                print(frame_str)
                print(frame_str_least)
                logger.info(frame_str)
                logger.info(frame_str_least)
